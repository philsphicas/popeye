...
static slice_index const slice_rank_order[] =
{
  ...
  STCASTInverseSingleCapturesRemover,
  ...
  STNullMoveGenerator,
  STKingMoveGenerator,
  STHalfInChessKingMoveGenerator,
  STAllInChessKingMoveGenerator,
  STNonKingMoveGenerator,
  STHalfInChessNonKingMoveGenerator,
  STAllInChessNonKingMoveGenerator,
  STPointReflectionWalkRestorer,
  STBicapturesUnrecolorPieces,
